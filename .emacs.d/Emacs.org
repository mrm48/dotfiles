...
* Startup Performance
Uncomment the definition of efs/display-startup-time and the hook to enable a startup message with performance metrics
...
I am using the [[https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/UbuntuMono/Regular/complete/Ubuntu%20Mono%20Nerd%20Font%20Complete%20Mono.ttf][Ubuntu Mono Nerd Fonts Complete]] font for this configuration which is not going to be installed on your machine. This will need to be downloaded from the repo linked. 
...
Additional settings for vterm, ivy, lsp
...
Add in ability to use Org Roam buffer toggle, insert and find nodes.
...
Add in jedi server configuration for python LSP functionality
