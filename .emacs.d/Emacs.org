...
* Startup Performance and Welcome Message
Add the definition of efs/display-startup-time and the hook to enable a startup message with performance metrics or use the custom welcome message
