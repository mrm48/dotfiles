...
It is very likely that the fonts I am using are not installed by default. I use [[https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/UbuntuMono/Regular/complete/Ubuntu%20Mono%20Nerd%20Font%20Complete%20Mono.ttf][UbuntuMono Nerd Font Complete]], which will need to be installed for this configuration to work without any changes. If another font is more appropriate for your system, modify the :font tag in the three lines under the Font Configuration section of Emacs.org
